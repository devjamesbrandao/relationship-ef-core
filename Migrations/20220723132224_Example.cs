    ...
    public partial class Example : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Students", x => new { x.Id, x.StoreId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressOfStudentStoreId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentAddresses", x => x.StudentAddressId);
                    table.ForeignKey(
                        name: "ForeignKey_Student_StudentAddress",
                        columns: x => new { x.AddressOfStudentId, x.AddressOfStudentStoreId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentAddresses_AddressOfStudentId_AddressOfStudentStoreId",
                table: "StudentAddresses",
                columns: new[] { "AddressOfStudentId", "AddressOfStudentStoreId" },
                unique: true);
        }
